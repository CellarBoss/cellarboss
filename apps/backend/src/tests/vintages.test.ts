...
import { createTestApp, createTestAppWithAuth, runMigrations, createTestWine, createTestWineMaker, createTestRegion, createTestCountry } from './setup.js';
...
describe('Vintage API', () => {
  ...
  describe('Authenticated operations', () => {
    ...
    beforeEach(async () => {
      ...
      const wine = await createTestWine(db, wineMaker.id, region.id, 'Château Latour');
      testWineId = wine.id;
