...
export function RegionWinesList({ regionId }: { regionId: number }) {
  ...
  const result = queryGate([wineQuery, winemakerQuery]);
  if (!result.ready) return result.gate;

  const [wines, winemakers] = result.data;
  ...
  return (
    <View style={styles.section}>
      ...
      <Pressable
        ...
        onPress={() => router.push(`/wines/new?regionId=${regionId}`)}
      >
